...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ssssssssssssidiisi", $name_en, $name_fa, $name_fr, $name_ar, $description_en, $description_fa, $description_fr, $description_ar, $ingredients_en, $ingredients_fa, $ingredients_fr, $ingredients_ar, $category_id, $price, $prep_time, $is_available, $main_image, $id);
    if ($stmt->execute()) {
        header("Location: manage_foods.php");
        exit();
    } else {
