...
<style>
    ...
    .admin-sidebar {
        ...
        padding-top: 70px;
        transition: transform 0.3s ease; /* برای انیمیشن در موبایل */
    }
    ...
    .admin-content {
        ...
        padding: 90px 30px 30px; /* فضای کافی برای هدر و منو */
        flex: 1;
    ...
    @media (max-width: 768px) {
        .admin-sidebar {
            display: block;
            position: fixed;
            bottom: 0 !important; /* اولویت بالا برای قرارگیری در پایین */
            top: auto !important; /* غیرفعال کردن top در موبایل */
            width: 100%;
            background: #34495e;
            ...
            padding: 10px 0;
            z-index: 1001;
            height: 60px; /* ارتفاع ثابت برای منو */
        ...
        .admin-sidebar ul {
            ...
            flex-wrap: wrap;
            align-items: center;
            height: 100%; /* ارتفاع کل منو را پر کند */
        }
        ...
        .admin-content {
            margin: 0;
            padding: 60px 10px 80px; /* پدینگ پایین بیشتر برای جلوگیری از همپوشانی با منو */
        }
