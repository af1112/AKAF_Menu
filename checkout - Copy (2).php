...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $name = $_POST['name'] ?? '';
    $phone = $_POST['phone'] ?? '';
	$type = $_POST['delivery_type'] ?? 'dine-in';
	$table_number = isset($_POST['delivery_type']) && $_POST['delivery_type'] == 'dine-in' ? ($_POST['table_number'] ?? null) : null;
	$address = isset($_POST['delivery_type']) && $_POST['delivery_type'] == 'delivery' ? ($_POST['address'] ?? null) : null;
	$contact_info = isset($_POST['delivery_type']) && $_POST['delivery_type'] == 'delivery' ? ($_POST['contact_info'] ?? null) : null;
